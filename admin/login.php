...
if(isset($_POST['btnLogin'])){
	...
	$sql=mysqli_query($mysqli,"select * from login where email_pengguna='$txtUsername' and password=md5('$txtPassword')");
	...
	$ra=mysqli_fetch_array($sql);
		...
		if($counta>0){
			session_start();
			$_SESSION['id_login']	= $ra['id_login'];
			$_SESSION['username']     = $ra['email_pengguna'];
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" >
                                        ...
                                        </div><button name="btnLogin" class="btn btn-primary btn-block text-white btn-user" type="submit">Login</button>
